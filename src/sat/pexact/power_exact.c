...
/////////////////////////////////////////////////////////////base bdd 
void Exa_ManExactPowerSynthesis_base_bdd(Bmc_EsPar_t *pPars, int verbose)
{
    int i, status, iMint = 1;
    abctime clkTotal = Abc_Clock();
    Exa_Man_t *p;
...
void Exa_ManExactPowerSynthesis_sw_free(Bmc_EsPar_t *pPars,int verbose,int bdd_opt)
{
